...
5. **M1.8 exit gate completion** — need ≥1 real problem for each of the 6 remaining renderers (recursion, tree, stack, queue, grid, graph). Each needs Gate 1 + Gate 2.
